...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [253460.740263, 6238312.603221, 260688.085555, 6243008.511737], maxZoom: 28, minZoom: 1
    })
});
...
map.getView().fit([253460.740263, 6238312.603221, 260688.085555, 6243008.511737], map.getSize());
